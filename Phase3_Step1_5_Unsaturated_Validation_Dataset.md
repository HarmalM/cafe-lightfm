...
| Min stage-specific negatives per (user, stage) | 0 (empirically) | 21 (guaranteed: 30 − 9) |

The negative-count guarantees are **deterministic**, not merely
probabilistically likely: they follow directly from the fixed subset
size (round(30 × 0.30) = 9) and the fixed number of stages (3),
